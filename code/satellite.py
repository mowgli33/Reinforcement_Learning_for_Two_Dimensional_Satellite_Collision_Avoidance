...
class Satellite:
    def __init__(self, Vx0, f0, num_debris=4):
        #Position
        self.Sx = 0
        self.Sy = 0
    ...
    def initialize_debris_velocities(self):
        ...
        for t_n in collision_times:
            Wx = (self.Sx + self.Vx * t_n - self.debris_positions[0][0]) / t_n
            Wy = (self.Sy + self.Vy * t_n - self.debris_positions[0][1]) / t_n
    ...
    def calculate_collision_probability(self):
        ...
        distances = np.linalg.norm(self.debris_positions - np.array([self.Sx, self.Sy]), axis=1)
...
class SatelliteEnvironment :
    def __init__(self, Vx0=0.5, f0=5, num_debris=4, max_orbit=2, beta=0.01, delta_t=0.1, max_time_steps=200):
        ...
        self.satellite = Satellite(Vx0, f0, num_debris)
    ...
    def reset(self):
        ...
        self.satellite = Satellite(Vx0=0.5, f0=5, num_debris=4)
        self.time_step = 0
